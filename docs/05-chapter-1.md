  ...
  <tbody>
    <tr>
      <td width="30%" align="center" valign="middle">
        <img src="../assets/chapter-1/alonso-higa-image.jpg" alt="Foto de Alonso Higa" width="180" style="border-radius: 8px;">
        <br>
        <i></i>
      </td>
    ...
    <tr>
      <td width="30%" align="center" valign="middle">
        <img src="../assets/chapter-1/martin-foto.jpg" alt="Foto de " width="180" style="border-radius: 8px;">
        <br>
        <i></i>
      </td>
      <td width="70%" valign="top" style="padding-left: 20px;">
        ...
        Dentro del equipo, cumplo el rol de un full stack al realizar actividades de documentación y programación a un nivel medio. Considero que soy una persona responsable y adaptable a distintas situaciones con buen time-management.</p>
      </td>
    </tr>
    <tr>
      <td width="30%" align="center" valign="middle">
...
<td width="30%" align="center" valign="middle">
        <img src="../assets/chapter-1/Lean-UX-canvas.png" alt="Lean UX Canvas " width="550" style="border-radius: 8px;">
        <br>
